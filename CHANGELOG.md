...
- Fixed the console prefix to no cause the command not found error. RM is a special disabled command so no error. but means everything will be RM> prefixed.
